...
class Simulation:
    ...
    def get_parameters(self, y_pred):
        bn = 3
...
if __name__ == "__main__":
    ...
    input_file = 'Record_Input.csv'
    output_file = 'Record_Output.csv'

    case_index = 0

    # Run simulation
    sim = Simulation(case_index, [n_cardiac_cyc, dt, save_last_n_cardiac_cycles],
